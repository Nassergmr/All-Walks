  ...
  return (
    <div>
      ...
      >
        ...
        <div
          id="left_section"
          className="pt-11 sticky h-[100vh] overflow-y-auto top-0 px-12"
        >
          <Elements
          ...
          >
            <Strapi totalAmount={totalAmount} />
          </Elements>
        </div>
        ...
        <div id="right_section">
          <div
            ...
            className="flex h-full border-l overflow-y-auto flex-col px-12 py-8 bg-gray-100 "
          >
            {cartItems.map((item) => (
              <>
                <div
                ...
                >
                  ...
                  <div id="left" className="h-full relative">
                    <div
                      id="img_container"
                      className="lg:w-[100px] lg:h-[100px] w-[70px]
h-[70px] relative"
                    >
                      {!isLoaded && (
                        <Skeleton
...
h-[70px]"
            ...
            <div
              id="total"
              className="flex justify-between items-center pt-[50px]"
            >
              <div className="">
          ...
          <div id="accordion_container">
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                <div className="flex py-8 justify-between items-center  border-y">
